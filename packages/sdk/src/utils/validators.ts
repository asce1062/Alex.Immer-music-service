...
export const TrackSchema = z.object({
  ...
  album: z.string(),
  album_id: z.string(),
  track_position: z.string().optional(),
...
export const AlbumSchema = z.object({
  ...
  file_size_human: z.string().optional(),
  bpm_range: z
    .object({
...
export const ManifestSchema = z.object({
  ...
  cdn: z.object({
    ...
    albums_path: z.string().optional(),
    covers_path: z.string().optional(),
    metadata_path: z.string().optional(),
    trackers_path: z.string().optional(),
  }),
